...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionScore'
        db.create_table('fack_questionscore', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fack.Question'])),
        ...
        db.send_create_signal('fack', ['QuestionScore'])


    def backwards(self, orm):
        # Deleting model 'QuestionScore'
        db.delete_table('fack_questionscore')
    ...
    models = {
        ...
        'fack.questionscore': {
            ...
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fack.Question']"}),
        ...
        'fack.topic': {
            ...
            'country_code': ('django.db.models.fields.CharField', [], {'default': "'BE'", 'max_length': '2'}),
