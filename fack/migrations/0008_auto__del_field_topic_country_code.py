...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Topic.country_code'
        db.delete_column('fack_topic', 'country_code')


    def backwards(self, orm):
        # Adding field 'Topic.country_code'
        db.add_column('fack_topic', 'country_code',
                      self.gf('django.db.models.fields.CharField')(default='BE', max_length=2),
                      keep_default=False)
