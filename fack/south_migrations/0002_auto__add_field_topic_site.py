...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fack_topic', 'site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.site'
        db.delete_column('fack_topic', 'site_id')
