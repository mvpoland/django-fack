...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fack_topic', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.icon'
        db.delete_column('fack_topic', 'icon')
